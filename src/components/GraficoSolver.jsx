...
const GraficoSolver = ({ problemData, onSolutionChange }) => {
  ...
  const generateChartData = (solutionData) => {
  ...
  const resolverGrafico = () => {
    if (!problemData || problemData.numVariables !== 2) {
      ...
      onSolutionChange && onSolutionChange(errorResult)
      return
    }
    ...
    try {
      ...
      onSolutionChange && onSolutionChange(result)
              ...
              {(() => {
                ...
                return chartData ? (
                  ...
                  <div className="flex items-center justify-center h-full">
                    <p className="text-gray-400">No se puede generar el gráfico</p>
                  </div>
                )
              })()}
            </div>
