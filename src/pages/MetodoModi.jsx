  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        ...
        >
          <h1 className="text-5xl font-bold text-white mb-4 bg-gradient-to-r from-rose-400 via-pink-500 to-violet-600 bg-clip-text text-transparent">
            📈 Método MODI
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Modified Distribution Method para optimización de transporte
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-md mx-auto">
            Próximamente tendrás toda la información y calculadora del Método MODI
          </p>
        </motion.div>
      </div>
    </motion.div>
