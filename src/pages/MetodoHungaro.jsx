      ...
      <div className="flex-1">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Algoritmo para resolver problemas de asignación óptima
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-md mx-auto">
            Próximamente tendrás toda la información y calculadora del Método Húngaro
          </p>
        </motion.div>
      </div>
    </motion.div>
